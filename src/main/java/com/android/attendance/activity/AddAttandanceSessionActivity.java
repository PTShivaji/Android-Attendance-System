...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "ise","cse"};
	private String[] yearString = new String[] {"1","2","3","4"};
	private String[] subjectSEString = new String[] {"FS","ST"};
	private String[] subjectTEString = new String[] {"WT","DM"};
	private String[] subjectBEString = new String[] {"TE","MAD"};

	private String[] subjectFinal = new String[] {"FS","ST","WT","DM","TE","MAD"};
